...
((SELECT category_id FROM category WHERE name = 'TRÂN CHÂU ĐƯỜNG ĐEN'), 'Sữa tươi trân châu đường đen', 'Một sự kết hợp hoàn hảo giữa vị ngọt thanh của đường đen và sự béo ngậy của sữa tươi nguyên chất. Điểm nhấn chính là những viên trân châu dai mềm, ngấm đều hương đường, tạo nên hương vị khó quên.', true, ''),
((SELECT category_id FROM category WHERE name = 'TRÂN CHÂU ĐƯỜNG ĐEN'), 'Caramel trân châu đường đen', 'Đậm đà với lớp caramel mịn màng, hòa quyện cùng vị ngọt dịu của đường đen và trân châu dai mềm. Thức uống này mang lại cảm giác ngọt ngào, béo nhẹ, rất thích hợp cho những tín đồ hảo ngọt.', true, ''),
((SELECT category_id FROM category WHERE name = 'TRÂN CHÂU ĐƯỜNG ĐEN'), 'Socola trân châu đường đen', 'Hương vị thơm nồng, đậm đà của socola hòa quyện cùng đường đen ngọt thanh. Trân châu dẻo dai làm tăng thêm sự thú vị cho mỗi ngụm thưởng thức. Đây là lựa chọn lý tưởng cho những ai yêu thích sự đậm đà và ngọt ngào.', true, ''),
((SELECT category_id FROM category WHERE name = 'TRÂN CHÂU ĐƯỜNG ĐEN'), 'Cacao trân châu đường đen', 'Một sự kết hợp tuyệt vời giữa vị đắng nhẹ của cacao nguyên chất và ngọt thanh của đường đen. Thức uống này vừa thơm vừa béo, mang lại cảm giác hài hòa và thư giãn.', true, ''),
...
((SELECT category_id FROM category WHERE name = 'TRÂN CHÂU ĐƯỜNG ĐEN'), 'Khoai môn trân châu đường đen', 'Hương khoai môn tự nhiên, bùi bùi kết hợp cùng vị ngọt thanh của đường đen và trân châu dẻo dai. Một thức uống vừa thơm, vừa đậm vị quê nhà.', true, ''),
((SELECT category_id FROM category WHERE name = 'TRÂN CHÂU ĐƯỜNG ĐEN'), 'Hoa đậu biếc trân châu đường đen', 'Với sắc xanh bắt mắt từ hoa đậu biếc, kết hợp cùng vị ngọt nhẹ của đường đen và trân châu dẻo dai, đây không chỉ là thức uống ngon mà còn rất tốt cho sức khỏe.', true, ''),
((SELECT category_id FROM category WHERE name = 'TRÂN CHÂU ĐƯỜNG ĐEN'), 'Oolong trân châu đường đen', 'Thưởng thức hương vị thanh tao, nhẹ nhàng của trà Oolong kết hợp cùng lớp đường đen ngọt dịu và trân châu mềm mại. Một sự lựa chọn lý tưởng để thư giãn và tận hưởng sự tinh tế.', true, ''),
((SELECT category_id FROM category WHERE name = 'TRÂN CHÂU ĐƯỜNG ĐEN'), 'Trà sữa trân châu đường đen', 'Kinh điển nhưng không bao giờ lỗi thời, trà sữa thơm ngon béo nhẹ hòa quyện cùng đường đen ngọt dịu và trân châu dai mềm. Thức uống này luôn là "must-try" cho bất kỳ ai yêu thích trà sữa.', true, '');

-- Sản phẩm thuộc danh mục: TRÀ SỮA
INSERT INTO product (category_id, name, description, is_signature, image_path) VALUES
((SELECT category_id FROM category WHERE name = 'TRÀ SỮA'), 'Trà sữa truyền thống', 'Hương vị quen thuộc với sự hòa quyện tinh tế giữa trà đen và sữa tươi. Vị ngọt vừa phải, thơm mát, thích hợp cho mọi lứa tuổi.', true, ''),
((SELECT category_id FROM category WHERE name = 'TRÀ SỮA'), 'Trà sữa socola', 'Đậm đà và ngọt ngào với hương socola thơm lừng, kết hợp cùng vị béo nhẹ của trà sữa.', true, ''),
((SELECT category_id FROM category WHERE name = 'TRÀ SỮA'), 'Trà sữa caramel', 'Sự hòa quyện của trà sữa béo mịn và caramel thơm ngọt, mang lại cảm giác ấm áp, đầy mê hoặc.', true, ''),
((SELECT category_id FROM category WHERE name = 'TRÀ SỮA'), 'Trà sữa matcha', 'Matcha thanh mát, thơm phức, kết hợp cùng sữa ngọt dịu tạo nên hương vị cân bằng, thư thái.', true, ''),
((SELECT category_id FROM category WHERE name = 'TRÀ SỮA'), 'Trà sữa khoai môn', 'Vị bùi bùi đặc trưng của khoai môn hòa quyện cùng trà sữa béo ngậy, ngọt ngào và hấp dẫn.', true, ''),
((SELECT category_id FROM category WHERE name = 'TRÀ SỮA'), 'Trà sữa việt quốc', 'Độc đáo với hương thơm và vị chua ngọt nhẹ của việt quất, kết hợp trà sữa làm nổi bật vị giác.', true, ''),
((SELECT category_id FROM category WHERE name = 'TRÀ SỮA'), 'Trà sữa kiwi', 'Thức uống kết hợp giữa vị ngọt dịu của trà sữa và hương vị chua ngọt, tươi mát từ trái kiwi. Sự pha trộn độc đáo này mang lại cảm giác sảng khoái và đầy năng lượng, rất phù hợp cho những ngày hè.', true, ''),
((SELECT category_id FROM category WHERE name = 'TRÀ SỮA'), 'Trà sữa đào', 'Ngọt thanh từ trái đào tươi, hòa quyện cùng trà sữa mát lạnh, mang lại cảm giác sảng khoái.', true, ''),
((SELECT category_id FROM category WHERE name = 'TRÀ SỮA'), 'Trà sữa đác', 'Vị trà sữa truyền thống thêm phần thú vị nhờ topping đác dai ngon, mát lạnh.', true, '');

-- Sản phẩm thuộc danh mục: TRÀ SỮA ĐẶC BIỆT
INSERT INTO product (category_id, name, description, is_signature, image_path) VALUES
((SELECT category_id FROM category WHERE name = 'TRÀ SỮA ĐẶC BIỆT'), 'Trà sữa The Way', 'Công thức độc quyền với hương vị đặc biệt, béo ngậy và thơm ngon, làm bạn phải say mê từ ngụm đầu tiên.', true, ''),
((SELECT category_id FROM category WHERE name = 'TRÀ SỮA ĐẶC BIỆT'), 'Trà sữa Vani', 'Mùi hương vani dịu nhẹ, ngọt ngào, kết hợp trà sữa làm nên thức uống tinh tế và đầy cuốn hút.', true, ''),
((SELECT category_id FROM category WHERE name = 'TRÀ SỮA ĐẶC BIỆT'), 'Trà sữa mầm cây', 'Sự kết hợp sáng tạo với topping xanh mát từ thiên nhiên, vừa ngon miệng vừa tốt cho sức khỏe.', true, ''),
((SELECT category_id FROM category WHERE name = 'TRÀ SỮA ĐẶC BIỆT'), 'Trà sữa hạt dẻ', 'Hương vị hạt dẻ bùi bùi hòa quyện cùng trà sữa ngọt dịu, mang lại cảm giác ấm áp.', true, ''),
((SELECT category_id FROM category WHERE name = 'TRÀ SỮA ĐẶC BIỆT'), 'Trà sữa Oolong', 'Thanh mát với hương trà oolong đậm đà, kết hợp cùng sữa ngọt dịu, làm nổi bật sự tinh tế.', true, ''),
((SELECT category_id FROM category WHERE name = 'TRÀ SỮA ĐẶC BIỆT'), 'Trà sữa Hokaido', 'Đậm đà, béo ngậy với sữa Hokkaido thơm ngon, mang phong cách Nhật Bản đặc trưng.', true, ''),
((SELECT category_id FROM category WHERE name = 'TRÀ SỮA ĐẶC BIỆT'), 'Trà sữa bánh Flan', 'Sự hòa quyện giữa vị ngọt béo của trà sữa và topping bánh flan mềm mịn, thơm ngon.', true, ''),
((SELECT category_id FROM category WHERE name = 'TRÀ SỮA ĐẶC BIỆT'), 'Trà sữa Kim cương Đen', 'Trân châu kim cương đen dẻo dai kết hợp trà sữa đậm đà, tạo nên sức hút khó cưỡng.', true, ''),
((SELECT category_id FROM category WHERE name = 'TRÀ SỮA ĐẶC BIỆT'), 'Trà sữa hoa đậu biếc', 'Màu xanh độc đáo từ hoa đậu biếc, hòa quyện trà sữa thanh mát, đẹp mắt và thơm ngon.', true, ''),
((SELECT category_id FROM category WHERE name = 'TRÀ SỮA ĐẶC BIỆT'), 'Trà sữa tứ quý mật ong', 'Sự kết hợp giữa bốn loại trà đặc biệt, thêm mật ong nguyên chất, mang lại vị thanh tao, ngọt dịu.', true, ''),
((SELECT category_id FROM category WHERE name = 'TRÀ SỮA ĐẶC BIỆT'), 'Trà sữa hạnh phúc', 'Công thức pha chế đặc biệt, mang lại cảm giác ngọt ngào và niềm vui cho mọi người.', true, ''),
((SELECT category_id FROM category WHERE name = 'TRÀ SỮA ĐẶC BIỆT'), 'Trà sữa Matcha Pudding đậu đỏ', 'Matcha thơm lừng kết hợp pudding mịn màng và đậu đỏ bùi bùi, tạo nên thức uống hấp dẫn.', true, ''),
((SELECT category_id FROM category WHERE name = 'TRÀ SỮA ĐẶC BIỆT'), 'Trà sữa khoai môn Pudding đậu đỏ', 'Hương khoai môn tự nhiên cùng pudding mềm mịn và đậu đỏ, tăng thêm phần đặc sắc.', true, ''),
((SELECT category_id FROM category WHERE name = 'TRÀ SỮA ĐẶC BIỆT'), 'Trà sữa Socola Cake Cream', 'Lớp kem bánh mềm mịn, thơm mát kết hợp socola đậm đà, tạo nên thức uống ngọt ngào khó quên.', true, ''),
((SELECT category_id FROM category WHERE name = 'TRÀ SỮA ĐẶC BIỆT'), 'Trà sữa Matcha Cake Cream', 'Matcha thanh mát thêm phần lôi cuốn với lớp kem bánh béo ngậy, mang lại trải nghiệm đẳng cấp.', true, '');

-- Sản phẩm thuộc danh mục: MACCHIATO/KEM CHEESE
INSERT INTO product (category_id, name, description, is_signature, image_path) VALUES
((SELECT category_id FROM category WHERE name = 'MACCHIATO/KEM CHEESE'), 'Hồng trà Machiato/Kem chese', 'Hồng trà đậm đà với lớp kem cheese mặn ngọt hài hòa, tạo nên một ly trà độc đáo.', true, ''),
((SELECT category_id FROM category WHERE name = 'MACCHIATO/KEM CHEESE'), 'Trà oolong Machiato/Kem chese', 'Trà oolong thanh tao kết hợp lớp kem béo ngậy, mang đến hương vị khó cưỡng.', true, ''),
((SELECT category_id FROM category WHERE name = 'MACCHIATO/KEM CHEESE'), 'Trà oolong đào Machiato/Kem chese', 'Vị đào thơm lừng hòa quyện cùng trà oolong và lớp kem cheese béo mịn.', true, ''),
((SELECT category_id FROM category WHERE name = 'MACCHIATO/KEM CHEESE'), 'Trà gạo rang Machiato/Kem chese', 'Thơm lừng với vị trà gạo rang độc đáo, thêm kem cheese tạo nên một ly trà đậm đà, lạ miệng.', true, ''),
((SELECT category_id FROM category WHERE name = 'MACCHIATO/KEM CHEESE'), 'Matcha Machiato/Kem chese', 'Vị trà xanh tươi mát kết hợp lớp kem cheese béo ngậy, làm nên thức uống đầy tinh tế.', true, ''),
((SELECT category_id FROM category WHERE name = 'MACCHIATO/KEM CHEESE'), 'Hoa đậu biếc Machiato/Kem chese', 'Màu sắc bắt mắt từ hoa đậu biếc và lớp kem cheese thơm ngon, là lựa chọn hoàn hảo cho người yêu cái đẹp.', true, '');

-- Sản phẩm thuộc danh mục: HOA HỒNG
INSERT INTO product (category_id, name, description, is_signature, image_path) VALUES
((SELECT category_id FROM category WHERE name = 'HOA HỒNG'), 'Sữa tươi hoa hồng trân châu', 'Hương hoa hồng nhẹ nhàng kết hợp sữa tươi và trân châu dai mềm, mang lại cảm giác lãng mạn.', true, ''),
((SELECT category_id FROM category WHERE name = 'HOA HỒNG'), 'Sữa tươi hoa hồng nha đam', 'Sữa tươi béo nhẹ cùng nha đam giòn mát, thêm hương hoa hồng làm thức uống thêm phần đặc biệt.', true, ''),
((SELECT category_id FROM category WHERE name = 'HOA HỒNG'), 'Trà hoa hồng Machiato', 'Trà hoa hồng thanh tao cùng lớp kem cheese ngậy béo, mang lại sự hài hòa độc đáo.', true, ''),
((SELECT category_id FROM category WHERE name = 'HOA HỒNG'), 'Trà hoa hồng Galaxy', 'Sắc màu galaxy cuốn hút, cùng hương thơm hoa hồng ngọt ngào, tạo nên thức uống tinh tế.', true, ''),
((SELECT category_id FROM category WHERE name = 'HOA HỒNG'), 'Trà hoa hồng Lệ Chi', 'Hương vị thanh mát từ hoa hồng và trái vải tươi, mang đến cảm giác ngọt ngào, dễ chịu.', true, ''),
((SELECT category_id FROM category WHERE name = 'HOA HỒNG'), 'Lục trà hoa hồng nha đam', 'Lục trà thanh mát kết hợp hương hoa hồng thơm dịu và nha đam giòn sật, là lựa chọn tuyệt vời cho ngày hè.', true, '');

-- Sản phẩm thuộc danh mục: TOPPING (Thạch)
INSERT INTO product (category_id, name, description, is_signature, image_path) VALUES
((SELECT category_id FROM category WHERE name = 'TOPPING'), 'Thạch rau cau', null, true, ''),
((SELECT category_id FROM category WHERE name = 'TOPPING'), 'Thạch trái cây', null, true, ''),
((SELECT category_id FROM category WHERE name = 'TOPPING'), 'Thạch cà phê', null, true, ''),
((SELECT category_id FROM category WHERE name = 'TOPPING'), 'Nha đam', 'Giòn mát, tự nhiên và giàu dưỡng chất, phù hợp với hầu hết các loại thức uống.', true, '');

-- Sản phẩm thuộc danh mục: TOPPING (Khác)
INSERT INTO product (category_id, name, description, is_signature, image_path) VALUES
((SELECT category_id FROM category WHERE name = 'TOPPING'), 'Bánh Flan', 'Mềm mịn, béo ngậy, tăng thêm phần đặc sắc cho ly trà sữa.', true, ''),
((SELECT category_id FROM category WHERE name = 'TOPPING'), 'Kim cương đen', 'Trân châu đen cao cấp, dẻo thơm, ngấm vị ngọt đậm đà.', true, ''),
((SELECT category_id FROM category WHERE name = 'TOPPING'), 'Phô mai khổng lồ', 'Viên phô mai béo ngậy, tan chảy trong miệng, là lựa chọn tuyệt vời cho những tín đồ phô mai.', true, '');
