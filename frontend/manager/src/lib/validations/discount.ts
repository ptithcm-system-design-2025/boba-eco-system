...
export function transformCreateDiscountFormData(
	formData: CreateDiscountFormData,
): CreateDiscountDto {
	return {
		name: formData.name,
...
export function transformUpdateDiscountFormData(
	formData: UpdateDiscountFormData,
): UpdateDiscountDto {
	return {
		name: formData.name,
		description: formData.description || undefined,
