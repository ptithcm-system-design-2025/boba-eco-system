...
export type BulkDeleteEmployeeFormData = z.infer<
	typeof bulkDeleteEmployeeSchema
>;

// Transform functions để chuyển đổi dữ liệu giữa frontend và backend
export function transformCreateEmployeeFormData(
...
export function transformUpdateEmployeeFormData(
