...
export const bulkDeleteCategorySchema = z.object({
	ids: z.array(z.number()).min(1, 'Phải chọn ít nhất một danh mục để xóa'),
});

// Types được suy ra từ schemas
export type CreateCategoryFormData = z.infer<typeof createCategorySchema>;
export type UpdateCategoryFormData = z.infer<typeof updateCategorySchema>;
export type BulkDeleteCategoryFormData = z.infer<
	typeof bulkDeleteCategorySchema
>;

// Transform functions để convert form data sang DTO backend
export function transformCreateCategoryFormData(
...
export function transformUpdateCategoryFormData(
