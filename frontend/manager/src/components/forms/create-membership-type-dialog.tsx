...
export function CreateMembershipTypeDialog({
	children,
}: CreateMembershipTypeDialogProps) {
		...
		<Dialog open={open} onOpenChange={setOpen}>
			...
			<DialogContent className="sm:max-w-[500px]">
				<DialogHeader>
					...
					<DialogDescription>
						Tạo loại thành viên mới với các quyền lợi và yêu cầu
						điểm tích lũy.
					</DialogDescription>
				</DialogHeader>
								...
								<FormItem className="flex flex-row items-center justify-between rounded-lg border p-3 shadow-sm">
									<div className="space-y-0.5">
										...
										<div className="text-sm text-muted-foreground">
											Loại thành viên này có hoạt động hay
											không
										</div>
									</div>
									<FormControl>
