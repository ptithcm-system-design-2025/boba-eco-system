		...
		<Dialog open={open} onOpenChange={setOpen}>
			...
			<DialogContent className="sm:max-w-[600px]">
				<DialogHeader>
					...
					<DialogDescription>
						Tạo khách hàng mới cho hệ thống. Số điện thoại là bắt
						buộc.
					</DialogDescription>
				</DialogHeader>
					...
					>
						...
						<div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
							<p className="text-sm text-blue-800">
								<strong>Lưu ý:</strong> Hệ thống sẽ tự động gán
								loại thành viên có điểm yêu cầu thấp nhất và đặt
								điểm tích lũy tương ứng cho khách hàng mới.
							</p>
						</div>
