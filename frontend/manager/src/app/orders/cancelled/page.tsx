...
export default function CancelledOrdersPage() {
	...
	const { orders, isLoading, isDeleting, fetchOrdersByStatus, deleteOrder } =
		useOrdersStore();
	...
	const columns: ColumnDef<Order>[] = [
		...
		},
		{
			...
			cell: ({ row }) => {
				const order = row.original;
				const employeeName =
					order.employeeName || order.employee?.name || 'N/A';
				...
				<AlertDialogContent>
					<AlertDialogHeader>
						...
						<AlertDialogDescription>
							...
							<strong>#{selectedOrder?.id}</strong>? Hành động này
							không thể hoàn tác và sẽ xóa vĩnh viễn tất cả dữ
							liệu liên quan.
						</AlertDialogDescription>
					</AlertDialogHeader>
					<AlertDialogFooter>
