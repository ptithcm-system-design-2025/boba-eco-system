import { ArrowRight, Package, Plus, Ruler, Tag } from 'lucide-react';
			...
			<div className="flex items-center justify-between">
				<div>
					...
					<p className="text-muted-foreground">
						Quản lý tất cả sản phẩm, danh mục và kích thước trong hệ
						thống
					</p>
				</div>
					...
					<div className="space-y-4">
						<div className="flex items-center gap-4 p-3 bg-muted/50 rounded-lg">
							...
							<div className="flex-1">
								...
								<p className="text-xs text-muted-foreground">
									Bánh kem chocolate - Danh mục bánh kem
								</p>
							</div>
						...
						<div className="flex items-center gap-4 p-3 bg-muted/50 rounded-lg">
							...
							<div className="flex-1">
								...
								<p className="text-xs text-muted-foreground">
									Bánh Cupcake - Dành cho bánh cỡ nhỏ
								</p>
							</div>
							<span className="text-xs text-muted-foreground">
								5 giờ trước
						...
						<div className="flex items-center gap-4 p-3 bg-muted/50 rounded-lg">
							...
							<div className="flex-1">
								<p className="text-sm font-medium">
									Kích thước mới được thêm
								</p>
								<p className="text-xs text-muted-foreground">
									XXL - 12 inch cho bánh lớn
								</p>
							</div>
							<span className="text-xs text-muted-foreground">
								1 ngày trước
