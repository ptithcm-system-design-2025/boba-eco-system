...
export default function CustomerDetailPage() {
	...
	const { customers, fetchCustomers, updateCustomer, isUpdating } =
		useCustomerStore();
	...
	const handleSaveInfo = async () => {
		...
		try {
			...
			if (infoForm.lastName !== customer.lastName)
				updateData.lastName = infoForm.lastName;
			if (infoForm.firstName !== customer.firstName)
				updateData.firstName = infoForm.firstName;
			if (infoForm.phone !== customer.phone)
				updateData.phone = infoForm.phone;
			if (infoForm.gender !== customer.gender)
				updateData.gender = infoForm.gender;
	...
	const handleSaveAccount = async () => {
		...
		try {
			...
			if (accountForm.password) {
				...
				toast.info(
					'Tính năng cập nhật mật khẩu sẽ được triển khai sau',
				);
			}
	...
	const membershipType = membershipTypes.find(
		(mt) => mt.id === customer.membershipTypeId,
	);
								...
								{membershipType ? (
									<div className="flex items-center gap-2">
										...
										<Badge
											...
											className="text-xs"
										>
											{membershipType.discountValue}% giảm
											giá
										</Badge>
									</div>
								) : (
									<p className="text-sm text-muted-foreground">
										Chưa có loại thành viên
									</p>
								)}
							</div>
								...
								<div className="space-y-2">
									...
									<div className="space-y-1 text-sm">
										<p>
											...
											{membershipType.requiredPoint} điểm
										</p>
										<p>
											<strong>Giảm giá:</strong>{' '}
											{membershipType.discountValue}%
										</p>
