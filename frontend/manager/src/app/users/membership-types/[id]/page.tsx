...
export default function MembershipTypeDetailPage() {
	...
	const membershipTypeId = parseInt(params.id as string, 10);
								...
								<div className="space-y-4">
									...
									<div className="flex items-center space-x-3">
										...
										<div>
											...
											<p className="text-sm text-muted-foreground">
												{membershipType.requiredPoint.toLocaleString()}{' '}
												điểm
											</p>
										</div>
									</div>
										...
										<FormField
											...
											render={({ field }) => (
												<FormItem>
													...
													<FormControl>
														<Input
															placeholder="VIP, Premium, Silver..."
															{...field}
														/>
													</FormControl>
													<FormMessage />
						...
						<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
							<div className="space-y-4">
								...
								<div>
									...
									<p className="text-sm text-muted-foreground">
										{formatDate(
											new Date(membershipType.createdAt),
										)}
									</p>
								</div>
							</div>
							...
							<div className="space-y-4">
								<div>
									...
									<p className="text-sm text-muted-foreground">
										{formatDate(
											new Date(membershipType.updatedAt),
										)}
									</p>
								</div>
							</div>
