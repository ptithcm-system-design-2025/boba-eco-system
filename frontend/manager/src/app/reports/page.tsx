...
export default function ReportsPage() {
	...
	const buildQuery = useCallback((): SalesReportQuery => {
			...
			switch (reportType) {
				...
				case 'daily':
					if (selectedMonth) {
						...
						toast.error(
							'Vui lòng chọn tháng để xem báo cáo theo ngày',
						);
						return;
					}
					break;
	...
	return (
		<div className="space-y-6">
			...
			<div className="flex items-center justify-between">
				<div>
					...
					<p className="text-muted-foreground">
						Thống kê và phân tích doanh thu, đơn hàng và hiệu suất
						bán hàng
					</p>
				</div>
			...
			{/* Summary Stats */}
			{currentReport && <SummaryStats summary={currentReport.summary} />}
				...
				<Tabs defaultValue="charts" className="space-y-4">
					...
					<TabsContent value="charts" className="space-y-6">
						...
						<div className="grid gap-6 md:grid-cols-2">
							...
							{currentReport.employee_sales &&
								currentReport.employee_sales.length > 0 && (
							...
							{/* Product Sales */}
							{currentReport.product_sales &&
								currentReport.product_sales.length > 0 && (
									<ProductSalesChart
									...
									<Card>
										...
										<CardContent>
											<div className="space-y-4">
												{currentReport.employee_sales.map(
													(employee) => (
														<div
															key={
				...
				<Card>
					<CardContent className="flex items-center justify-center h-96">
						<div className="text-center">
							...
							<p className="text-muted-foreground">
								Không tìm thấy dữ liệu báo cáo cho khoảng thời
								gian đã chọn
							</p>
						</div>
					</CardContent>
